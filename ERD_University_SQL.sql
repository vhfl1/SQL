insert into `departments` values (10, '국문학과', '051-510-1010');
...
insert into `departments` values (32, '생명과학학과', '051-510-1032');
insert into `departments` values (40, '기계공학학과', '051-510-1040');

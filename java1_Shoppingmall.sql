...
insert into `Users` values ('user3', '김춘추', '1989-05-30', 'M', '010-1103-1989', null, 0, 1, '서울', now());
insert into `Users` values ('user4', '이사부', '1979-04-13', 'M', '010-2101-1979', 'leesabu@naver.com', 0, 1, '서울', now());
insert into `Users` values ('user5', '장보고', '1966-09-12', 'M', '010-2104-1966', 'jangbg@naver.com', 0, 1, '대전', now());
insert into `Users` values ('user6', '선덕여왕', '1979-07-28', 'M', '010-3101-1979', 'queen@naver.com', 0, 1, '대전', now());
insert into `Users` values ('user7', '강감찬', '1984-06-15', 'F', '010-4101-1984', 'kang@naver.com', 0, 1, '대구', now());
insert into `Users` values ('user8', '신사임당', '1965-10-21', 'M', '010-5101-1965', 'sinsa@naver.com', 0, 1, '대구', now());
insert into `Users` values ('user9', '이이', '1972-11-28', 'F', '010-6101-1972', 'leelee@naver.com', 0, 1, '부산', now());
insert into `Users` values ('user10', '허난설헌', '1992-09-10', 'F', '010-7103-1992', null, 0, 1, '광주', now());
...
insert into `Points` values (4, 'user4', 3610, '상품구매 5% 적립', now());
insert into `Points` values (5, 'user5', 3000, '이벤트 응모 3000 적립', now());
insert into `Points` values (6, 'user6', 1000, '회원가입 1000 적립', now());
insert into `Points` values (7, 'user7', 2000, '이벤트 응모 2000 적립', now());
insert into `Points` values (8, 'user8', 2615, '상품구매 5% 적립', now());
insert into `Points` values (9, 'user9', 1500, '이벤트 응모 1500 적립', now());
insert into `Points` values (10, 'user10', 15840, '상품구매 2% 적립', now());

insert into `Sellers` values (10001, '(주)다팔아', '02-201-1976', '정우성', '서울');
insert into `Sellers` values (10002, '팜매의 민족', '02-102-1975', '이정재', '서울');
...
insert into `Products` values (120103, 12, 10010, '바로구이 부채살 250g', null, 21000, 62, 10);
insert into `Products` values (130101, 13, 10006, '[ANF]식스프리 강아지 사료', 58, 56000, 142, 0);
insert into `Products` values (130112, 13, 10006, '중대형 사계절 강아지 옷', 120, 15000, 80, 0);
...
insert into `Orderitems` values (13, 22010710110, 120103, 20000, 10, 5);

...
insert into `bank_transaction` (`t_a_no`, `t_dist`, `t_datetime`) values ('101-11-1001', 3, now());
...
insert into `bank_transaction` (`t_a_no`, `t_dist`, `t_datetime`) values ('101-11-2003', 3, now());
...
#2-16
select max(`t_amount`), min(`t_amount`) 
